...
local function Protect(inst)
    if type(gethui) == "function" then
        local ok = pcall(function() inst.Parent = gethui() end)
        if ok then return end
    end
    if syn and type(syn.protect_gui) == "function" then
        pcall(function() syn.protect_gui(inst) end)
    end
    pcall(function() inst.Parent = CoreGui end)
end
...
local function LoadConfig()
    if type(isfile) == "function" and isfile("RagnarokConfig.json") and type(readfile) == "function" then
